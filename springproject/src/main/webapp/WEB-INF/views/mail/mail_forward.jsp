...
<title>foward mail</title>
</head>

<body>
	<form method="post" action="mailForward" id="mail_forward"
		name="mail_forward" enctype="multipart/form-data">
				...
				<div class="col-sm-12" style="text-align: center">
					...
					<div class="input-group mb-3 input-group-sm">
						...
						<input type="email" name="m_fromemail" id="m_fromemail"
							class="form-control" value="${sessionemail}" readonly>
						<div class="input-group-prepend">
							<button class="btn btn-secondary" disabled type="button"
								style="width: 116px">
						...
						<input type="text" name="m_fromname" id="m_fromname" class="form-control"
							value="${sessionname}" data-required="true" readonly>
						</div>
					<div class="input-group mb-3 input-group-sm">
						<div class="input-group-prepend">
							<button class="btn btn-secondary" disabled type="button"
						...
						<input type="email" name="m_toemail" id="m_toemail"
							class="form-control" value="" onchange="toNameChange(this)" >
							<div class="input-group-prepend">
							<button class="btn btn-secondary" disabled type="button"
								style="width: 116px">
						...
						<div class="input-group mb-3 input-group-sm">
							<div class="input-group-prepend">
								<button class="btn btn-secondary" disabled type="button"
								style="width: 116px"><i
									class="fas fa-globe-americas"></i>글제목</button>
							</div>
							<input type="text" name="m_title" id="m_title"
								placeholder="title" class="form-control" data-required="true"
								value="FW:${emailbox.m_title}">
						</div>
						...
						<div class="input-group mb-3 input-group-sm">
							<div class="input-group-prepend">
								<button class="btn btn-secondary" disabled type="button"
								style="width: 116px"><i
									class="fas fa-paperclip"></i>첨부파일</button>
							</div>
							<input type="file" name="m_file" id="m_file"
								onchange="filesizeChk()" value="${emailbox.m_attach}" style="width: 80%">
						</div>
						...
						<div class="input-group mb-3 input-group-sm">
							<div class="input-group-prepend">
								<button class="btn btn-secondary" disabled type="button"
								style="width: 116px"><i
										class="fas fa-minus-circle">파일크기</i></button>
							</div>
						...
						<div class="btn-group">
							<button type="submit"  class="btn btn-success">전달 보내기</button>

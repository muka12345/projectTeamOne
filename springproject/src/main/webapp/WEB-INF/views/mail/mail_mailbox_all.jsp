...
<head>
<meta charset="UTF-8">
<title>전체편지함(개발자용)</title>
</head>


<body>
	<form method="get" action="mailboxAllForm" name="mailboxAll"
		...
		<div class="container" id="mailboxForm"
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row">
						<input type="text" value="전체메일함-(${rowCount})"
					...
					<div class="row">
						...
						<div class="col-md-6"
							...
							<div class="btn-group" style="height: 33px; float: left;">
								...
								<button type="button" id="deleteadmin" name="deleteadmin"
									class="btn btn-success" style="float: left;">바로삭제</button>
								<button type="button" id="checkadmindelete"
									class="btn btn-danger" style="float: left;">삭제</button>
								<button type="button" id="checkspam" class="btn btn-dark"
									style="float: left;">스펨</button>
							</div>
						</div>
						<div class="col-md-1"
							style="display: table-cell; height: 33px; float: left;">
		...
		<div class="col-sm-12" style="margin-top: 10px">
				...
				<div class="col-sm-12">
					...
					[<a href="mailboxAllSelected?page=${page}&find=${find}&pageSize=${pageSize}">${page }</a>]
					</c:forEach>
				</div>

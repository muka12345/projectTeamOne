...
<body>
	<form method="get" action="mailboxInputForm" name="mailboxinput"
		...
		<div class="container" id="mailboxForm"
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row">
						<input type="text" value="받은편지함-(${rowCount})"
					...
					<div class="row">
						<div class="col-md-5"
							...
							<SELECT class="selectpicker" id="selectfind" name="selectfind"
								...
								<option value="m_date">받은날짜</option>
						...
						<div class="col-md-6"
							...
							<div class="btn-group" style="height: 33px; float: left;">
								...
								<button type="button" id="checksave" class="btn btn-success"
									style="float: left;">이동저장</button>
								<button type="button" id="checkdelete" class="btn btn-danger"
									style="float: left;">삭제</button>
								<button type="button" id="checkspam" class="btn btn-dark"
									style="float: left;">블랙리스트</button>
							</div>
						</div>
						<div class="col-md-1"
							style="display: table-cell; height: 33px; float: left;">
				...
				<div class="col-sm-12" style="text-align: center">
					...
					[<a href="mailboxPageSelected?page=${page}&find=${find}">${page }</a>]
					</c:forEach>
				</div>
				<div class="row"></div>

...
<body>
	<form method="get" action="mailboxSaveForm" name="mailboxdelete"
		...
		<div class="container" id="mailboxForm"
			...
			<div class="row">
				<div class="col-md-12">
					<div class="row">
						<input type="text" value="저장편지함-(${rowCount})"
					...
					<div class="row">
						<div class="col-md-5"
							...
							<SELECT class="selectpicker" id="selectfind" name="selectfind"
								...
								<option value="m_toname" selected>보낸사람</option>
						...
						<div class="col-md-6"
							...
							<div class="btn-group" style="height: 33px; float: left;">
								...
								<button type="button" id="savemove"
									class="btn btn-success" style="float: left;">저장해제</button>

...
<body>
	<form method="get" action="mailboxOutputForm" name="mailboxOutput"
	...
	<div class="container" id="mailboxForm"
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row">
						<input type="text" value="보낸메일함-(${rowCount})"
					...
					<div class="row">
						<div class="col-md-5"
							...
							<SELECT class="selectpicker" id="selectfind" name="selectfind"
								...
								<option value="m_toname" selected>받은사람</option>
						...
						<div class="col-md-6"
							...
							<div class="btn-group" style="height: 33px; float: left;">
								...
								<button type="button" id="checksave" 
									class="btn btn-success" style="float: left;">이동저장</button>
								<button type="button" id="checkdelete" class="btn btn-danger"
					...
					<div class="col-sm-12">
						...
						<table id="example" name="checkboxTestTbl"  class="table table-striped table-bordered"
							...
							<c:forEach var="emailboxs" items="${emailboxs}">	
								...
								<tr style="text-align: center">
									...
									<td class="text-middle"><input type="checkbox" name="mailcheckbox"></td>
									<td class="text-middle"><c:choose><c:when test="${emailboxs.m_show eq 'Y'}">
									<i class="fas fa-envelope-open"></i></c:when><c:otherwise>
									<i class="fas fa-envelope"></i></c:otherwise></c:choose></td>
...
<a href="#" onClick="importartOn('${emailboxs.m_seq}'); return false;" ><i class="far fa-star"></i></a>
									...
									<td class="text-middle"><c:if
											...
											<a href="#" onClick="downloadEncoding('${emailboxs.m_attach}'); return false;">
					...
					[<a href="mailboxOutputSelected?page=${page}&find=${find}">${page }</a>]
					</c:forEach>
					</div>
					<div class="row">

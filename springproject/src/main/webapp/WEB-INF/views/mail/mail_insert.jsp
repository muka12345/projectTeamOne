...
<title>insert mail</title>
</head>

<body>
	<form method="post" action="returnResultPage" id="mail_insert"
			...
			<div class="row">
				...
				<div class="col-sm-12" style="text-align: center">
					...
					<div class="input-group mb-3 input-group-sm">
						<div class="input-group-prepend">
							<button class="btn btn-secondary" disabled type="button"
								style="width: 116px">
								<i class="fas fa-at">From email</i>
							</button>
						</div>
						<input type="email" name="m_fromemail" id="m_fromemail"
							class="form-control" value="${sessionemail}" required>
						...
						<input type="text" name="m_fromname" id="m_fromname"
							class="form-control" value="${sessionname }" data-required="true">
					</div>
					<div class="input-group mb-3 input-group-sm">
						<div class="input-group-prepend">
							<button class="btn btn-secondary" disabled type="button"
						...
						<input type="email" autocomplete="m_toemail" name="m_toemail"
							id="m_toemail" class="form-control" required>
						<div class="input-group-prepend">
							<button class="btn btn-secondary" disabled type="button"
								style="width: 116px">
								<i class="fas fa-at">받는사람</i>
							</button>
						</div>
					...
					<div class="input-group mb-3 input-group-sm">
						...
						<input type="email" name="m_cc" id="m_cc" placeholder="참조"
							class="form-control">
					</div>
					...
					<div class="input-group mb-3 input-group-sm">
						...
						<input type="text" name="m_title" id="m_title" placeholder="title"
							class="form-control" data-required="true" autofocus="autofocus">
					</div>
					...
					<div class="input-group mb-3 input-group-sm">
						...
						<input type="file" name="m_file" id="m_file"
							onchange="filesizeChk()" value="" style="width: 85%">
					</div>
					...
					<div class="input-group mb-3 input-group-sm">
						...
						<textarea id="m_content" name="m_content" placeholder="content"
							...
							data-required="true" data-parsley-errors-container="글 내용을 입력하세요!"></textarea>
					</div>
					<div class="row">
						<input type="hidden" id="m_temporary" value="N"> <input
							type="hidden" id="m_spam" value="n"> <input
							type="hidden" id="m_show" value="n"> <input
							type="hidden" id="m_delete" value="n">
					</div>

					<div class="btn-group">
						<button type="button" id="emailsend" class="btn btn-success">보내기</button>
						<button type="button" id="emailtemporary"
							class="btn btn-secondary">임시저장</button>
						<button type="reset" class="btn btn-primary">리셋</button>
						<button type="button" class="btn btn-dark"
							onclick="closeInsert()">작성취소</button>
					</div>

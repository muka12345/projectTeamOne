...
<body>
	<form method="get" action="mailboxSpamForm" name="mailboxinput"
		...
		<div class="container" id="mailboxForm"
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row">
						<input type="text" value="스펨메일함-(${rowCount})"
					...
					<div class="row">
						...
						<div class="col-md-6"
							...
							<div class="btn-group" style="height: 33px; float: left;">
								...
								<button type="button" id="checksavespam" class="btn btn-success"
								style="float: left;">스펨해제</button>
								<button type="button" id="deleteend" class="btn btn-danger"
								style="float: left;">완전삭제</button>
							</div>
						</div>
						<div class="col-md-1"
							style="display: table-cell; height: 33px; float: left;">
...
<a href="#" onClick="importartOn('${emailboxs.m_seq}'); return false;" ><i class="far fa-star"></i></a>
				...
				<div class="col-sm-12">
					...
					[<a href="mailboxSpamSelected?page=${page}&find=${find}">${page }</a>]
					</c:forEach>
				</div>

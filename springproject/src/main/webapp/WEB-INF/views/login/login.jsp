...
<body class="bg-dark">
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        <form id="login_form" name="login_form" action="login"  method="post" data-parsley-validate="true">
        ...
        <div class="text-center">
          ...
          <h2 class="d-block small" id="findpassword"><a href="findPasswordForm">Forgot Password?</a></h2>
        </div>
      </div>
    </div>
  </div>
